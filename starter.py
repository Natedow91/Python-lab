...
# Use a for-in loop to iterate over the `numbers` array, and if a number is even, add  it to the `even_numbers` 
# array.
...
if (change_my_mind = true) { change_my_mind = false; }
if (change_my_mind = false) { change_my_mind = true; }
